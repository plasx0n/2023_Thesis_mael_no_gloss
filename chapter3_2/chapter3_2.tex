...
À partir des instructions identifiées et intégrées dans les cœurs de processeur RISC-V, nous avons développé des versions spécifiques des codes sources des décodeurs logiciels dans des formes proches de celles décrites dans \cite{BLG:TURBO,BLG:SIPS:LDPC,Cass21}.
...
Par exemple, les turbo codes, avec seulement $2$ instructions spécialisées possibles, ne gagnent que $\approx 15~20\%$. 

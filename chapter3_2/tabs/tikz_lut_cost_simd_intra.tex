...
\begin{figure}[!tb]
  ...
  \begin{axis}[
   ...
   {(LDPC,434) (SC,410) (F-SC,423) (LDPC-NB,364) (TURBO,531)};
   ...
   {(LDPC,545) (SC,436) (F-SC,484) (LDPC-NB,354) (TURBO,570)};
...
\begin{axis}[
 ...
 \addplot[very thick,draw=Paired-1] plot coordinates{
    (Base,339) (LDPC,311) (SC,309) (F-SC,313) (LDPC-NB,269) (TURBO,321) };
 \addlegendentry{PicoRV32}

\addplot[very thick,draw=Paired-3, mark=o] plot coordinates {
    (Base,99) (LDPC,102) (SC,104) (F-SC,97) (LDPC-NB,102) (TURBO,106) };
\addlegendentry{IBEX}

\addplot[very thick,draw=Paired-7, mark=triangle] plot coordinates 
      {(Base,102) (LDPC,100) (SC,102) (F-SC,104) (LDPC-NB,102) (TURBO,99) };
\addlegendentry{SCR1}

...
\begin{tikzpicture}
	% triangle top left
          \foreach \x in {1,...,35}{
            \draw[very thick, color = couleur-ecole, opacity = 0.25] (0,4.428+\x*4.128/35) -- (7,6.4+\x*4.128/35);
          }
	...
	\def\posiy{-24}
          \foreach \x in {1,...,35}{
            \draw[very thick, color = couleur-ecole, opacity = 0.15] (\posix+0.02,\posiy+6.4+\x*4.128/35) -- (\posix+7+0.02,\posiy+4.428+\x*4.128/35);
          }
          ...
          \def\posy{4}
          \foreach \x in {1,...,35}{
            \draw[very thick, color = couleur-ecole, opacity = 0.25] (\posx,\posy+4.428+\x*4.128/35) -- (7+\posx,\posy+6.4+\x*4.128/35);
          }
